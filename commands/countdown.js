...
//        .addField("Beta Ends - 2017-07-26 1am UTC **(UPDATED)**", getTimeRemaining("2017-07-26 01:00:00 UTC"))
        .addField("PC Pre-Order Beta Start - 2017-08-28 5pm UTC", getTimeRemaining("2017-08-28 17:00:00 UTC"))
        .addField("PC Open Beta Start - 2017-08-29 5pm UTC", getTimeRemaining("2017-08-29 17:00:00 UTC"))
        .addField("PC Beta Ends - 2017-09-01 1am UTC", getTimeRemaining("2017-09-01 01:00:00 UTC"))
        .addField("Early Warning Net Offline", "All Guardians Report to the Tower")
        .addField("PS4 / XB1 Launch - 2017-09-06 12:00 AM (we hope?) UTC", getTimeRemaining("2017-09-06 00:00:00 UTC"))
        .addField("PC Launch - 2017-10-24 12:00 AM (we pray?) UTC", getTimeRemaining("2017-10-24 00:00:00 UTC"))
